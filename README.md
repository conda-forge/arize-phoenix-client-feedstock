About arize-phoenix-client-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/arize-phoenix-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/arize-phoenix-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add arize-phoenix-client
# for installing globally
pixi global install arize-phoenix-client
```
...
It is possible to list all of the versions of `arize-phoenix-client` available on your platform:
...
```
pixi search arize-phoenix-client --channel conda-forge
```
